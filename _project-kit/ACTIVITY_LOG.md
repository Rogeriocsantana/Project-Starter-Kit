...
| 2026-08-12 | Codex | evolução do kit | Implementou governança proporcional 2.4.0 após validação prática na SPEC-011 do Portal Maternidade | classes G0–G4, continuidade, escalada, templates e fluxo visual em lotes | `governance/TASK_GOVERNANCE.md`; `proposals/P-008-governanca-proporcional-por-unidade-de-mudanca.md`; templates; validadores | validar em outro projeto antes de promover a maturidade experimental |
